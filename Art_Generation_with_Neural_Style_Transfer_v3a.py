...
def compute_layer_style_cost(a_S, a_G):
    ...
    GS = gram_matrix(a_S) #notice that the input of gram_matrix is A: matrix of shape (n_C, n_H*n_W)
    GG = gram_matrix(a_G)
...
def model_nn(sess, input_image, num_iterations = 200):
    sess.run(tf.global_variables_initializer()) # <Gema> Run the initialization. Now all variables are initialized.
